  ...
  return (
    <View style={categories.container}>
      ...
      <TouchableOpacity style={categories.card}>
        <Text style={categories.title}>Proses</Text>
      </TouchableOpacity>
      <TouchableOpacity style={categories.card}>
        <Text style={categories.title}>Terjadwal</Text>
      </TouchableOpacity>
    </View>
  );
};
  ...
  return (
    <TouchableOpacity style={direct.container}>
      <View style={{flexDirection: 'row', alignItems: 'center', gap: 10}}>
        ...
        <Text style={direct.text}> Transaksi GoPay </Text>
      </View>
        ...
        <View style={history.content}>
          ...
          <View>
            <View
              ...
              <Text style={{...history.text, fontSize: 15}}>
                Roti Gembong, Malang
              </Text>
              <Text
                style={{
